...
(defroutes role-view-routes
  (context "/role" []
    ...
    (GET "/:id" [id]
      ...
      :responses {200 {:schema {:role {:id Integer
                                       :name String
    ...
    (PUT "/:id" [id :as {body :body}]
      ...
      :body [role {(s/optional-key :name) String
                   (s/optional-key :description) String
                   (s/optional-key :users) [{:id Integer}]}]
      :responses {200 {:schema {:role {:id Integer :name String :description (s/maybe String) :users [{:id Integer}]}}
